...
@allure.feature("Personal Data Form")
@allure.story("Form Submission")
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("Test form submission with valid data")
@allure.description("This test verifies that the form can be submitted with valid data and checks field colors.")
